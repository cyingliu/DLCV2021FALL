...
def save_checkpoint(checkpoint_path, model_G, model_D, optimizer_G, optimizer_D, scheduler_G, scheduler_D):
    ...
    'sch_G': scheduler_G.state_dict(), 'scheduler_D': scheduler_D.state_dict()}
    ...
    for e in range(args.epoch):
        for i, data in enumerate(train_dataloader):
            ...
            for _ in range(args.G_step):
                ...
                loss_G = - torch.mean(torch.log(fake_logit))
        ...
        if e % args.save_epoch == 0:
            ...
            save_checkpoint(checkpoint_path, model_G, model_D, optimizer_G, optimizer_D, scheduler_G, scheduler_D)
